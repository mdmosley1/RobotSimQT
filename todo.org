...
* TODO write method that converts april tag x,y,theta measurments into global coordinate measurements
  - just for clarity
* TODO add noise for april tag heading angle measurement
* TODO adjust noise to be centered at zero
* TODO tag should only turn green if collision is with vehicle
  - have tag fade to red after being detected
* TODO add more april tags
* TODO make FOV yellow instead of red
...
* TODO write a target tracking program that estimates future position of moving car and shoots projectile at the predicted position
